...
docker run -it -v $PWD/data:/data rawkintrevo/covid-basis-vectors:0.1.8 /opt/spark/bin/spark-submit --master local[*] --class org.rawkintrevo.covid.App /covid-0.1-jar-with-dependencies.jar  200 15 1
